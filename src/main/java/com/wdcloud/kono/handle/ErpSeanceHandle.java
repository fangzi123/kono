...
@Slf4j
@Component
public class ErpSeanceHandle implements Handle {
    ...
    public void handleRequest(Request request) {
        ...
        List<ErpSeanceDTO> dtoList= SysUtils.getDataFromKono(Constants.TABLE_ERP_SEANCE, ErpSeanceDTO.class);
        if (ListUtils.isNotEmpty(dtoList)) {
            Example example= new Example(ErpSeance.class);
