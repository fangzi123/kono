...
@Slf4j
@Component
public class ErpCursusHandle implements Handle {
    ...
    public void handleRequest(Request request) {
        ...
        List<ErpCursusDTO> dtoList= SysUtils.getDataFromKono(Constants.TABLE_ERP_CURSUS, ErpCursusDTO.class);
        if (ListUtils.isNotEmpty(dtoList)) {
            Example example= new Example(ErpCursus.class);
