...
@Slf4j
@Component
public class ErpInstancemoduleprofHandle implements Handle {
    ...
    public void handleRequest(Request request) {
        ...
        List<ErpInstancemoduleprofDTO> dtoList= SysUtils.getDataFromKono(Constants.TABLE_ERP_INSTANCEMODULEPROF, ErpInstancemoduleprofDTO.class);
        if (ListUtils.isNotEmpty(dtoList)) {
            Example example= new Example(ErpInstancemoduleprof.class);
